...
- Extract [the downloaded archive](http://phplucidframe.sithukyaw.com/download/release/latest) in your local webserver document root, and you will get a folder named **LucidFrame-x.y.z** where **x.y.z** would be your downloaded version.
- Rename it as **LucidFrame**.
- Open your terminal or command line and CD to your project root, and then run `php lucidframe secret:generate`. For more about the LucidFrame console, read [the documentation section 16](http://phplucidframe.sithukyaw.com/cookbook).
- Check `http://localhost/LucidFrame` in your browser.
